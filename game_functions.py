...
def check_keydown_events(event, ai_settings, screen, stats, ship, aliens, bullets):
    ...
    if event.key == pygame.K_RIGHT:
        ...
        if not stats.game_active:
            ...
            play_game(stats, ai_settings, screen, ship, aliens, bullets)
...
def play_game(stats, ai_settings, screen, ship, aliens, bullets):
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button):
    ...
    # При каждом переходе цикла перересовывается новый экран
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship,
    ...
    Alien.image = pygame.image.load('Взрыв.png')
    ...
    if collisions:
        ...
        pygame.mixer.music.play()
    if len(aliens) == 0:
        start_new_level(ai_settings, bullets, screen, stats, sb, ship, aliens)


def start_new_level(ai_settings, bullets, screen, stats, sb, ship, aliens):
...
def create_fleet(ai_settings, screen, ship, aliens):
    ...
    # Создает пришельца и вычисление количества пришельцев в ряду.
    alien = Alien(ai_settings, screen)
